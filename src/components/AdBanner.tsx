    ...
    return (
      <div className={`transition-all duration-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-1'}`}>
        <a
          ...
          className="block"
        >
          <div className={`relative overflow-hidden bg-gradient-to-r ${ad.bgGradient} rounded-2xl p-4 shadow-lg cursor-pointer hover:shadow-xl transition-shadow`}>
            ...
            <div className="relative flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span className="px-4 py-1.5 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white text-xs font-semibold rounded-lg transition-all whitespace-nowrap">
                  {ad.ctaText}
                </span>
    ...
    return (
      <div className={`transition-all duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        <a
          ...
          className="block"
        >
          <div className={`relative overflow-hidden bg-gradient-to-br ${ad.bgGradient} rounded-2xl p-5 shadow-lg cursor-pointer hover:shadow-xl transition-shadow`}>
            ...
            <div className="text-center space-y-3 pt-2">
              ...
              <span className="inline-block px-6 py-2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white text-sm font-semibold rounded-xl transition-all">
                {ad.ctaText}
              </span>
            </div>
          </div>
  ...
  return (
    <div className={`transition-all duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <a
        ...
        className="block"
      >
        <div className={`relative overflow-hidden bg-gradient-to-r ${ad.bgGradient} rounded-xl p-3 shadow-md mx-4 cursor-pointer hover:shadow-lg transition-shadow`}>
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <span className="px-3 py-1 bg-white/20 hover:bg-white/30 text-white text-[11px] font-semibold rounded-lg transition-all whitespace-nowrap">
                {ad.ctaText}
              </span>
